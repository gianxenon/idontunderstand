...
public class cred_uiAdapter extends BaseAdapter {

    FragmentManager fragmentManager;
    FragmentTransaction fragmentTransaction;
    public Context context;
    public ArrayList<ListPojos> listpojos;
    public cred_uiAdapter(Context context, ArrayList<ListPojos> listpojos){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               Intent intent =  new Intent("call.cred_uis.action");
               intent.putExtra("code",listpojos.get(position).getDeb_code());
